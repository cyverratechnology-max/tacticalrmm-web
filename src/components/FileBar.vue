...
export default {
  ...
  methods: {
    ...
    openHelp(mode) {
      ...
      switch (mode) {
        case "github":
          url = "https://github.com/cyverratechnology-max/tacticalrmm/";
          break;
        case "docs":
        ...
        case "bug":
          url =
            "https://github.com/cyverratechnology-max/tacticalrmm/issues/new?template=bug_report.md";
          break;
        case "feature":
          url =
            "https://github.com/cyverratechnology-max/tacticalrmm/issues/new?template=feature_request.md";
          break;
        case "discord":
